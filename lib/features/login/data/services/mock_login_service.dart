...
class MockLoginService extends BaseLoginService with MockService {
  @override
  ...
  Future<Response<dynamic>> failRequest(LoginRequestParams? params) async {
    return Future.delayed(
        const Duration(
          milliseconds: MockApiService.millisecondsDurationMockApiService,
        ), () {
      return LoginRequestResponse.errorResponse;
    });
  }
}
